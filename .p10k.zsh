...
# Generated by Powerlevel10k configuration wizard on 2019-11-03 at 11:13 AEDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( !VCS_STATUS_NUM_CONFLICTED && !VCS_STATUS_NUM_STAGED && !VCS_STATUS_NUM_UNSTAGED && !VCS_STATUS_NUM_UNTRACKED )) && res+="${clean}o"
  ...
  typeset -g POWERLEVEL9K_STATUS_PREFIX='%fhad '
